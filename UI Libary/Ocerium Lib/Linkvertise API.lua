...
local CREATOR_DISCORD_SERVER = "https://discord.gg/SNWXxh3wVu"-- i change to my link discord so yey
local API_HOST = "linkvertise.thisisusedfornothingotherthantohostafewscripts.xyz" -- api but expired 
